...
║│ *CREATOR* : HITMAN
║│ wa.me/6282156986313
║│ ${999 + pendaftar.length} User Registered
║╰───────
║╭───────          
║├「 *LIST MENU* 」
║│
...
Contoh : *${prefix}googlesearch siapa itu Mika*
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *Mika*
...
*DONASI BISA MELALUI :*
*DANA/PULSA/OVO : 082155483269*
*PAYPAL : COMINGSOON@gmail.com*
*SAWERIA : saweria.co/HITMANFF*
